...
                    <!-- !! FIXED: Changed p.overview to p.description -->
                    <p class="post__content-overview">${p.description}</p>
                </div>
                <div class="post__interact">
                    <div class="post__interact-meta">
                        <span class="created_date">${new Date(p.createdAt).toLocaleDateString('vi-VN', { day: '2-digit', month: '2-digit' })}</span>
                        <!-- TODO: Replace hardcoded likes/comments with p.likes.length -->
                        <span><img src="/images/show-post-img/Heart.svg" class="react-icon-meta" style="display: inline;"/> ${p.likes.length}</span>
                        <span><img src="/images/show-post-img/Comment.svg" class="react-icon-meta" style="display: inline;"/> 0</span>
                    </div>
...
              _</div>
            </div>
            <img src="${p.thumbnailUrl || '/images/post-thumbnail.png'}" class="post__img"/>
  _     </div>
