async function loadPost() {
    ...
    container.innerHTML = posts.map((p, index) =>
        ...
        <div class="post__author">
            <img src="/images/author-logo.png" alt="author" class="post__author-img"/>
            ...
            <div class="post__left-text">
                ...
                <div class="post__interact">
                    <div class="post__interact-meta">
                        ...
                        <span><img src="/images/heart-regular.svg" class="react-icon-meta" style="display: inline;"/> 5.5K</span>
                        <span><img src="/images/comment-regular-full.svg" class="react-icon-meta" style="display: inline;"/> 170</span>
                    </div>
